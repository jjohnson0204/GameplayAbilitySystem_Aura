...
/*void AAuraHUD::InitAttributeMenu(APlayerController* PC, APlayerState* PS, UAbilitySystemComponent* ASC,
	UAttributeSet* AS)
{
	checkf(AttributeMenuWidgetClass,
		TEXT("Attribute Menu Class uninitialized, please fill out BP_AuraHUD")
	);
	...
	UUserWidget* Widget = CreateWidget(GetWorld(), AttributeMenuWidgetClass);
